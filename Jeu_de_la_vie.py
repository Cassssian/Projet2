...
class JeuDeLaVie:
    ...
    def afficher(self):
        """
        Affiche le tableau jeu (noir = 0, blanc = 1)
        """
        if os.name == 'nt':
            os.system('cls')
        else:
    ...
    def valeur_case(self, i, j):
        ...
        """
        if i < 0 or i > len(self.tab) - 1:
            return 0
        elif j < 0 or j > len(self.tab[i]) - 1:
            return 0
        else:
            return self.tab[i][j]
    ...
    def resultat(self, valeur_case, total_voisins):
        ...
        if valeur_case == 0:
            ...
            if total_voisins != 2 and total_voisins != 3:
                valeur_case = 0
        return valeur_case
